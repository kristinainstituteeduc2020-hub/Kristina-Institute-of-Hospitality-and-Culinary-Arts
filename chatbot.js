...
Named pilot implementer of the Strengthened Senior High School Curriculum in Tarlac Province.`;
    ...
    const STRENGTHENED_SHS_TRACKS = `STRENGTHENED SENIOR HIGH SCHOOL PROGRAM TRACKS:

TECHNICAL-PROFESSIONAL TRACK
- Agri-Fishery/Food Innovation
- Artisanry
...
if(matchAny(['strengthened senior high','strengthened senior','senior high school','shs','s.h.s','shs tracks','academic track','technical-professional track','technical professional track','technical professional','technical track','program tracks','tracks'])){
      return STRENGTHENED_SHS_TRACKS;
    }
