...
<head>
  ...
  <title>TESDA Assessment Details</title>
    ...
    <div class="container header-inner">
      <div class="brand">
        ...
        <div>
          ...
          <div class="brand-subtitle">TESDA Assessment Details</div>
        </div>
      </div>
      <nav class="nav">
      ...
      <div class="details-card">
        ...
        <div class="details-body">
          ...
          <div class="details-meta">
            ...
            <span><?php echo h($item['created_at'] ? (new DateTime($item['created_at']))->format('Y-m-d') : ''); ?></span>
          </div>
